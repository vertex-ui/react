...
describe('Container', () => {
  ...
  it('applies default classes', () => {
    ...
    expect(containerDiv).toHaveClass('lxs-container');
    expect(containerDiv).toHaveClass('lxs-container--lg'); // Default maxWidth
  });
  ...
  it('forwards ref', () => {
    ...
    expect(ref.current).toHaveClass('lxs-container');
  });
