...
import type { OrderConfirmationProps } from '../../widgets/OrderConfirmation';
...
const meta = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'A comprehensive order confirmation component that displays order details, items, pricing, shipping information, and action buttons after a successful purchase.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    status: {
      control: 'select',
      options: ['pending', 'processing', 'confirmed', 'delivered', 'cancelled'],
    },
    loading: {
      control: 'boolean',
    },
